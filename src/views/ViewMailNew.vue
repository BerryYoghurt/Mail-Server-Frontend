<template>
  ...
  <div class="modal fade" id="copyModalMail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="copyModalMailLabel">{{state.mailAction}}</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body" v-if="destinationFolders.length">
      ...
      <div v-else class="modal-body">
        <h5>No custom folders to move to</h5>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" v-if="destinationFolders.length" data-bs-dismiss="modal" class="btn btn-primary" @click="processMail">{{state.mailAction}}!</button>
      </div>
    </div>
  </div>
</div>
    ...
    <nav class="my-4">
      <ul class="pagination justify-content-center">
        ...
        <li class="page-item" data-bs-toggle="modal" data-bs-target="#copyModalMail" @click="state.mailAction='copy'">
        ...
        <li class="page-item" data-bs-toggle="modal" data-bs-target="#copyModalMail" @click="state.mailAction='move'">
...
export default {
    ...
    setup(props) {
      ...
      async function processMail() {
        ...
        console.log(data);
        await axios.put(encodeURI(url), data, {
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json'
          },
